...
//
// use generated_module::tools.schema;
//
// fn main() {
...
pub struct ToolsSchema {
    ...
    is_consumed: bool,
    /// Specifies whether the Tool is available on horseback.
    is_horseback_usable: bool,
    /// Specifies whether the Tool is available on ladders.
    is_ladder_usable: bool,
...
pub enum ToolCategory {
    Aromatic,
    #[serde(rename = "Crystal Tear")]
    CrystalTear,
    Edible,
    Essential,
    #[serde(rename = "Golden Rune")]
    GoldenRune,
    Grease,
    #[serde(rename = "Great Rune")]
    GreatRune,
    Offensive,
    Online,
    Pot,
