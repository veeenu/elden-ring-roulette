...
//
// use generated_module::talismans.schema;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: talismans.schema = serde_json::from_str(&json).unwrap();
// }

use serde::{Serialize, Deserialize};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TalismansSchema {
    /// Array of other talismans this one conflicts with.
