...
//
// use generated_module::armaments.schema;
//
// fn main() {
...
pub struct ArmamentsSchema {
    ...
    /// Behavior variation ID used to identify attack params.
    behavior_variation_id: i64,
    /// Class of the Armament.
...
pub struct AffinityProperties {
    ...
    damage: Damage,
    /// Full hex ID override for the Armament with Affinity applied.
    full_hex_id: String,
    /// Base guarded damage negation values.
    guard: Guard,
...
pub struct Resistance {
    bleed: Option<i64>,
    death_blight: Option<i64>,
    frostbite: Option<i64>,
    madness: Option<i64>,
    poison: Option<i64>,
    scarlet_rot: Option<i64>,
    sleep: Option<i64>,
}
...
/// An enumeration.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum ArmamentCategory {
    Axe,
    Ballista,
    Bow,
    Claw,
    #[serde(rename = "Colossal Sword")]
    ColossalSword,
    #[serde(rename = "Colossal Weapon")]
    ColossalWeapon,
    Crossbow,
    #[serde(rename = "Curved Greatsword")]
    CurvedGreatsword,
    #[serde(rename = "Curved Sword")]
    CurvedSword,
    Dagger,
    Fist,
    Flail,
    #[serde(rename = "Glintstone Staff")]
    GlintstoneStaff,
    #[serde(rename = "Great Hammer")]
    GreatHammer,
    #[serde(rename = "Great Spear")]
    GreatSpear,
    Greataxe,
    Greatbow,
    Greatshield,
    ...
    Halberd,
    Hammer,
    #[serde(rename = "Heavy Thrusting Sword")]
    HeavyThrustingSword,
    Katana,
    #[serde(rename = "Light Bow")]
    LightBow,
    #[serde(rename = "Medium Shield")]
    MediumShield,
    Reaper,
    #[serde(rename = "Sacred Seal")]
    SacredSeal,
    #[serde(rename = "Small Shield")]
    SmallShield,
    Spear,
    #[serde(rename = "Straight Sword")]
    StraightSword,
    #[serde(rename = "Thrusting Sword")]
    ThrustingSword,
    Torch,
    Twinblade,
    Whip,
...
/// An enumeration.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum ArmamentUpgradeMaterial {
    None,
    #[serde(rename = "Smithing Stone")]
    SmithingStone,
    #[serde(rename = "Somber Smithing Stone")]
    SomberSmithingStone,
}
