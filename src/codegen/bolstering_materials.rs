...
//
// use generated_module::bolstering-materials.schema;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: bolstering-materials.schema = serde_json::from_str(&json).unwrap();
// }

use serde::{Serialize, Deserialize};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BolsteringMaterialsSchema {
    /// Bolstering Material category to discern its use.
    category: BolsteringMaterialCategory,
...
/// An enumeration.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum BolsteringMaterialCategory {
    Flask,
    Glovewort,
