...
//
// use generated_module::spells.schema;
//
// fn main() {
...
pub struct SpellsSchema {
    ...
    /// Specifies whether the Spell buffs a shield in the left hand.
    is_shield_buff: bool,
    /// Specifies whether the Item is visible to other players if dropped.
    is_tradable: bool,
    /// Specifies whether the Spell buffs a weapon in the right hand.
    is_weapon_buff: bool,
    ...
    /// Attribute requirements of the Spell.
    requirements: Requirements,
    /// Specifies the number of Memory Slots occupied.
    slots_used: i64,
