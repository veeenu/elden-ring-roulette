...
//
// use generated_module::ammo.schema;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: ammo.schema = serde_json::from_str(&json).unwrap();
// }

use serde::{Deserialize, Serialize};

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AmmoSchema {
    /// Category of the Ammo.
    ...
    /// Status effects of the Ammo, dealt on hit.
